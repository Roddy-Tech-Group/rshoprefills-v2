...
<x-layouts.dashboard>
    <div class="flex w-full flex-col gap-5">
        ...
        {{-- Empty state --}}
        <div class="rounded-[10px] bg-[#eff6ff] px-6 py-16 text-center border border-zinc-200 shadow-md shadow-zinc-900/[0.06] dark:border-zinc-700 dark:shadow-none">
        ...
        {{-- Security note --}}
        <div class="flex items-start gap-3 rounded-[10px] bg-[#eff6ff] p-4 dash-shimmer border border-zinc-200 shadow-md shadow-zinc-900/[0.06] transition-colors hover:border-green-200 dark:border-zinc-700 dark:hover:border-white dark:shadow-none">
