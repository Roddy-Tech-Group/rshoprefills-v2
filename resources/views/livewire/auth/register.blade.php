...
<div class="flex flex-col sm:flex-1">
    ...
    <div class="mx-auto flex w-full max-w-md flex-col py-3 sm:flex-1 sm:justify-center sm:py-8">
        ...
        <p class="mt-2 text-center text-sm text-zinc-500">Join RshopRefills and start shopping today</p>
        ...
        <form wire:submit="register" class="flex flex-col gap-3 sm:gap-4">
            ...
            <div>
                ...
                @error('name') <p class="mt-1 text-center text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
            ...
            <div x-data="{ show: false }">
                ...
                @error('password_confirmation') <p class="mt-1 text-center text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
        ...
        <div class="flex items-center justify-center gap-3">
            <a href="https://facebook.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook page" class="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 bg-white transition-colors hover:bg-zinc-50">
            ...
            <a href="https://x.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on X" class="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 bg-white transition-colors hover:bg-zinc-50">
                <svg viewBox="0 0 24 24" class="h-4 w-4 text-zinc-900" fill="currentColor" aria-hidden="true">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/>
                </svg>
            </a>
            <a href="https://tiktok.com/@rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on TikTok" class="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 bg-white transition-colors hover:bg-zinc-50">
            ...
            <a href="https://instagram.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" class="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 bg-white transition-colors hover:bg-zinc-50">
        ...
        {{-- Security note --}}
        <div class="mt-4 flex items-center justify-center gap-1.5 text-xs text-zinc-500 sm:mt-6">
