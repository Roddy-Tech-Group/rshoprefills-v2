...
<div class="flex flex-col sm:flex-1">
    ...
    <div class="mx-auto flex w-full max-w-sm flex-col py-3 sm:flex-1 sm:justify-center sm:py-6">
        ...
        <p class="mt-2 text-center text-sm text-zinc-600 dark:text-zinc-400">Sign in to your {{ $siteName }} account</p>
        ...
        <form wire:submit="login" class="flex flex-col gap-3 sm:gap-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="w-full rounded-[12px] border border-zinc-300 bg-white py-2.5 pl-10 pr-3 text-sm text-zinc-900 placeholder:text-zinc-600 outline-none transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500"
                    />
                </div>
            ...
            <div x-data="{ show: false }">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="w-full rounded-[12px] border border-zinc-300 bg-white py-2.5 pl-10 pr-12 text-sm text-zinc-900 placeholder:text-zinc-600 outline-none transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500"
                    />
                    <button
                        type="button"
                        @click="show = !show"
            ...
            <div class="flex items-center justify-between">
                <label class="flex cursor-pointer select-none items-center gap-2">
                    <input wire:model="remember" type="checkbox" class="h-4 w-4 rounded-[12px] border-zinc-300 text-blue-600 focus:ring-blue-500/30" />
                    <span class="text-base text-zinc-700 dark:text-zinc-300">Remember me</span>
                </label>
            ...
            <div wire:ignore class="mb-2">
                @if(config('services.turnstile.enabled') && config('services.turnstile.enforce_auth'))
                    <div class="cf-turnstile" data-sitekey="{{ config('services.turnstile.site_key') }}" data-callback="onTurnstileSuccessLogin" data-theme="light"></div>
                    <script>
        ...
        <div class="my-3 flex items-center gap-4 sm:my-5">
            <span class="h-px flex-1 bg-zinc-200 dark:bg-zinc-700"></span>
            <span class="text-sm text-zinc-600 dark:text-zinc-400">Connect with us on our socials</span>
            <span class="h-px flex-1 bg-zinc-200 dark:bg-zinc-700"></span>
        </div>

        {{-- Social row --}}
        <div class="flex items-center justify-center gap-3">
            <a href="https://facebook.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook page" class="flex h-11 w-11 items-center justify-center rounded-[12px] border border-zinc-200 bg-white transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700">
            ...
            <a href="https://x.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on X" class="flex h-11 w-11 items-center justify-center rounded-[12px] border border-zinc-200 bg-white transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700">
                <svg viewBox="0 0 24 24" class="h-4 w-4 text-zinc-900" fill="currentColor" aria-hidden="true">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/>
                </svg>
            </a>
            <a href="https://tiktok.com/@rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on TikTok" class="flex h-11 w-11 items-center justify-center rounded-[12px] border border-zinc-200 bg-white transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700">
            ...
            <a href="https://instagram.com/rshoprefills" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" class="flex h-11 w-11 items-center justify-center rounded-[12px] border border-zinc-200 bg-white transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700">
