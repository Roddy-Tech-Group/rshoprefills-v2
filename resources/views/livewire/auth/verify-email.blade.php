...
<div class="flex flex-1 flex-col">
    ...
    <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center py-8">
        ...
        @if (session('status') == 'verification-link-sent')
            <div class="mt-6 flex items-start gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                <svg class="mt-0.5 h-5 w-5 shrink-0 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
                ...
                <p class="text-sm text-emerald-800">A new verification link has been sent to your email address.</p>
            </div>
        @endif
        ...
        <div class="mt-6 flex flex-col gap-3">
            <button
                ...
                type="button"
                class="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-600/25 transition-colors hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50"
            >
            ...
            <button
                wire:click="logout"
                type="button"
                class="text-center text-sm font-medium text-zinc-500 underline-offset-4 transition-colors hover:text-zinc-800 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40"
            >
                Log out
            </button>
        </div>
