...
<div class="flex flex-col sm:flex-1">
    ...
    <div class="mx-auto flex w-full max-w-md flex-col py-3 sm:flex-1 sm:justify-center sm:py-8">
        ...
        @if (session('status') == 'verification-link-sent')
            <div class="mt-6 flex items-center justify-center gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                ...
                <p class="text-center text-sm text-emerald-800">A new verification link has been sent to your email address.</p>
            </div>
        @endif
