                    ...
                    <div class="flex items-start gap-4 rounded-[10px] bg-white p-5 ring-1 ring-zinc-100">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="mt-3 flex flex-wrap gap-2">
                                <a href="tel:{{ $supportPhoneDial }}" aria-label="Call global support" class="inline-flex items-center gap-1.5 rounded-[10px] bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100">
                                ...
                                <a href="sms:{{ $supportPhoneDial }}" aria-label="iMessage global support" class="inline-flex items-center gap-1.5 rounded-[10px] bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100">
                                ...
                                <a href="https://wa.me/{{ $supportPhoneWa }}" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp global support" class="inline-flex items-center gap-1.5 rounded-[10px] bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-700 transition-colors hover:bg-emerald-100">
