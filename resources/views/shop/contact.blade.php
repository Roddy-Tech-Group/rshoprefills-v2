        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-10">
                ...
                <div class="rounded-[24px] bg-white p-6 shadow-sm shadow-zinc-900/5 ring-1 ring-zinc-100 sm:p-8">
                    @if (session('contact_sent'))
                        ...
                        <div class="flex flex-col items-center py-10 text-center">
                            ...
                            <a href="{{ route('shop.contact') }}" wire:navigate class="mt-6 inline-flex items-center gap-2 rounded-[10px] bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-700">
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                ...
                                <div x-data="{ open: false, subject: @js(old('subject', $defaultSubject)) }" @click.outside="open = false" @keydown.escape="open = false" class="relative">
                                    ...
                                    <button
                                        ...
                                        class="flex w-full items-center justify-between gap-2 rounded-[10px] border border-zinc-300 bg-white px-3.5 py-2.5 text-left text-sm font-medium text-zinc-900 outline-none transition-colors hover:border-zinc-400 focus:border-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/15"
                                    >
                                    ...
                                    >
                                        @foreach ($subjects as $s)
                                            <button
                                                ...
                                                role="option"
                                                class="flex w-full items-center justify-between gap-2 rounded-[10px] px-3 py-2 text-left text-sm font-medium transition-colors"
            ...
            <div>
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4 rounded-[10px] bg-white p-5 ring-1 ring-zinc-100">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="mt-3 grid grid-cols-3 gap-2">
                                <a href="tel:{{ $supportPhoneDial }}" aria-label="Call global support" class="flex items-center justify-center gap-1.5 rounded-[10px] bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100">
                                ...
                                <a href="sms:{{ $supportPhoneDial }}" aria-label="iMessage global support" class="flex items-center justify-center gap-1.5 rounded-[10px] bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100">
                                ...
                                <a href="https://wa.me/{{ $supportPhoneWa }}" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp global support" class="flex items-center justify-center gap-1.5 rounded-[10px] bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700 transition-colors hover:bg-emerald-100">
                    ...
                    <div class="rounded-[10px] bg-blue-600 p-6">
                    ...
                    <div class="rounded-[10px] bg-white p-5 ring-1 ring-zinc-100">
                        <div class="mb-3 flex items-center gap-2.5">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] text-white" style="background-color: #5865F2;">
