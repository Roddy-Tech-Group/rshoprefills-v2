    ...
    <div class="mx-auto w-full max-w-[1140px] px-4 py-12 sm:px-6 sm:py-16">
        ...
        <section id="collect" class="mt-12 scroll-mt-24">
            ...
            <div class="mt-5 space-y-4">
                <div class="rounded-2xl bg-zinc-50 p-5 ring-1 ring-zinc-100">
                ...
                <div class="rounded-2xl bg-zinc-50 p-5 ring-1 ring-zinc-100">
                    ...
                    <div class="mt-4 flex items-start gap-3 rounded-xl bg-blue-50 p-4 ring-1 ring-zinc-100">
        ...
        <section id="sharing" class="mt-12 scroll-mt-24">
            ...
            <div class="my-5 rounded-2xl bg-blue-600 p-6">
