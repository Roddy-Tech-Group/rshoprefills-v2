...
<a
    ...
    class="group flex items-center justify-between gap-3 rounded-[10px] bg-white px-4 py-3.5 ring-1 ring-zinc-200 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md hover:ring-zinc-300 dark:bg-[#1d3252] dark:ring-zinc-700/60 dark:hover:ring-zinc-600"
>
