...
<section data-reveal aria-label="Why shop with RshopRefills">
    <ul class="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-5">
        ...
        {{-- Best Prices --}}
        <li class="flex min-h-[110px] items-center gap-3 rounded-[14px] border-2 border-zinc-200 bg-transparent p-4 transition-colors duration-200 hover:border-zinc-300 sm:min-h-0 sm:p-5 dark:border-zinc-700 dark:hover:border-zinc-600">
