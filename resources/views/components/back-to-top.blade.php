...
<button
    ...
    class="flex items-center justify-center rounded-full bg-blue-600 text-white shadow-lg shadow-blue-600/30 ring-2 ring-blue-600/20 transition-colors hover:bg-blue-700 focus:outline-none focus-visible:ring-blue-500/60"
>
