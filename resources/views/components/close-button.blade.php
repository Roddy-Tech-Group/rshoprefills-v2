...
--}}
<button {{ $attributes->merge(['type' => 'button', 'aria-label' => 'Close'])->class('flex h-8 w-8 shrink-0 items-center justify-center rounded-[6px] bg-black text-white transition-colors hover:bg-zinc-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 dark:bg-white/20 dark:hover:bg-zinc-500') }}>
