...
class TransactionPinTest extends TestCase
{
    ...
    public function test_wallet_payment_flow_requires_pin()
    {
        ...
        $order = Order::forceCreate([
            ...
            'order_status' => \App\Domain\Order\Enums\OrderStatus::Pending,
            'payment_status' => \App\Domain\Payment\Enums\PaymentStatus::Pending,
            'fulfillment_status' => \App\Domain\Fulfillment\Enums\FulfillmentStatus::NotStarted,
        ...
        $providerInitData = app(\App\Domain\Payment\Providers\WalletPaymentProvider::class)->initializePayment($attempt);
