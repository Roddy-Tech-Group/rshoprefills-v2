...
|--------------------------------------------------------------------------
|
| Editable list of blog articles shown on /blog and at /blog/{slug}. No
| database needed: add, edit or remove entries here. `image` is a file in
| public/assets. `body` is an array of paragraphs.
|
*/
