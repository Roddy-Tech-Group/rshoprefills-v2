...
|--------------------------------------------------------------------------
|
| Editable list of press releases / newsroom posts shown on /press and at
| /press/{slug}. No database needed: add, edit or remove entries here.
| `image` is a file in public/assets. `body` is an array of paragraphs.
|
*/
